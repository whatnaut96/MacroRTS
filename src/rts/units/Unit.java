...
public class Unit implements Serializable {
     ...
     * constructor without explicit ID is used
     */
    ...
    /**
     * Creates a unit without specifying its ID. It is automatically assigned
     * from {@link #next_ID}, which is incremented.
     *
     * @param a_player
     * @param a_type
     * @param a_x
    ...
    /**
     * Sets the type of this unit. Note: this should not be done lightly. It is
     * currently thought to be used only when the GUI changes the unit type
     * table, and tries to create a clone of the current game state, but
     * changing the UTT.
     *
     * @param a_type
     */
    ...
    /**
     * Changes the unique identifier Note: Do not use this function unless you
    ...
    /**
     * Returns the index of this unit in a {@link PhysicalGameState} (as it is
     * an 'unrolled matrix')
     *
     * @param pgs
     * @return
    ...
    /**
     * Returns true if the unit is idle (i.e. if it's not executing any actions)
     *
     * @return
     */
    ...
    /**
     * Returns a list of actions this unit can perform in a given game state. An
     * idle action for 10 cycles is always generated
     *
     * @param s
     * @return
     */
    ...
    /**
     * Returns a list of actions this unit can perform in a given game state. An
     * idle action for noneDuration cycles is always generated
     *
     * @param s
     * @param noneDuration the amount of cycles for the idle action that is
     * always generated
     * @return
     */
