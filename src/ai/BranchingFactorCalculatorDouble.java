...
public class BranchingFactorCalculatorDouble {
    ...
    public static double branchingFactorUpperBound(GameState gs, int player) throws Exception {
        PlayerActionGenerator pag = new PlayerActionGenerator(gs, player);
        return pag.getSize();
    }
    
    
    public static double branchingFactor(GameState gs, int player) throws Exception {
        double n = 0;
        PlayerActionGenerator pag = new PlayerActionGenerator(gs, player);
...
//            System.out.println("FF");
    ...
    public static double branchingFactorByResourceUsageSeparatingFast(GameState gs, int player) throws Exception {
...
//        System.out.println(areas);
        ...
        for(int area:areas) {
            ...
            double []n = branchingFactorByResourceUsageFastInternal(gs3,player);
...
//            System.out.println(" ]");
    ...
    public static double[] branchingFactorByResourceUsageFastInternal(GameState gs, int player) throws Exception {
        GameState gs2 = gs.clone();
        PhysicalGameState pgs2 = gs2.getPhysicalGameState();
...
//                if (DEBUG>=1) System.out.println("  Resources Used: " + resourcesUsed);
                ...
                double []unitBranching = new double[playerResources+1];
                for(UnitAction1 ua:ual) {
