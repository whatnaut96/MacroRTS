...
/**
 * @deprecated Old version of the A* code. Retained for unit tests, 
 * such that we can use it to verify that newer code still produces 
 * equal results.
 *
 *
 * @author santi
 ...
 */
@Deprecated
public class OldAStarPathFinding extends PathFinding {
